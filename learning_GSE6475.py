...
selected_gene_count_df.to_csv('final_State_cross_sample_selected_gene_count_state_1200genes.csv')
print(plot_rewards)
q_table_df = pd.DataFrame(q_table)
q_table_df.to_csv('final_State_cross_sample_Reward_q-table_1200genes.csv')
