...
plt.tight_layout()
# plt.show()
plt.savefig(f'training_GSE6475_results_plot_{timestamp}.png')
...
selected_gene_df.to_csv('final_v2_cross_sample_selected_gene_count_stateGSE6475_2000.csv', index=False)

q_table = agent.model.get_Q_table()
q_table_df = pd.DataFrame(q_table)
q_table_df.to_csv('final_v2_cross_sample_q-table_2000_GSE6475.csv')
